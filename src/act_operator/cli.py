...
console = Console()
app = typer.Typer(help="Act Operator CLI", invoke_without_command=True)
...
ACT_NAME_OPTION = typer.Option(
    None, "--act-name", help="Display name of the Act project"
)
CAST_NAME_OPTION = typer.Option(
    None, "--cast-name", help="Display name of the initial Cast"
)
...
NEW_CAST_NAME_OPTION = typer.Option(
    None, "--cast-name", help="Display name of the Cast to add"
)
